...
export function FeedbacksGrid({ testimonials }: { testimonials: Testimonial[] }) {
              ...
              return (
                <div key={t.id} className="bg-[var(--bg-surface-2)] border border-[var(--border)] rounded-2xl overflow-hidden hover:border-[var(--gold-border)] transition-colors">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-[var(--text-primary)] leading-relaxed italic mb-5 text-sm">
                      "{t.feedback}"
                    </p>
          ...
          <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
            {textTestimonials.map((t) => (
              <div key={t.id} className="break-inside-avoid">
                <div className="bg-[var(--bg-surface-2)] border border-[var(--border)] hover:border-[var(--gold-border)] transition-colors rounded-2xl p-7 flex flex-col">
                  ...
                  <p className="text-[var(--text-primary)] leading-relaxed italic mb-6 flex-grow">
                    "{t.feedback}"
                  </p>
